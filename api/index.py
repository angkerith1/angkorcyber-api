...
def angkor_health():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return jsonify({"error": "Angkor API unavailable"}), 502
    except:
        return jsonify({"error": "Cannot connect to Angkor API"}), 502
...
def angkor_check():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return jsonify({"error": "Check service unavailable"}), 502
    except:
        return jsonify({"error": "Cannot connect to check service"}), 502
...
def angkor_databases():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return jsonify({"error": "Databases service unavailable"}), 502
    except:
        return jsonify({"error": "Cannot connect to databases service"}), 502
...
def json_users():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return jsonify({"error": "JSON service unavailable"}), 502
    except:
        return jsonify({"error": "Cannot connect to JSON service"}), 502
